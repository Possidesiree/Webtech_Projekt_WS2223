...
import htw.berlin.webtech.Webtech.email.EmailSender;
...
public class RegistrationService {
    ...
    public RegistrationService(BenutzerKontoService benutzerKontoService,
    ...
    public BenutzerKonto register(RegistrationRequest request) {
        ...
        return benutzerKontoService.signUpUser(
                new BenutzerKonto(
    ...
    public String confirmToken(String token) {
        ...
        benutzerKontoService.enableAppUser(
                confirmationToken.getBenutzerKonto().getEmail());
        return "confirmed";
    }
